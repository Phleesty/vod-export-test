...
title = "Мертвый стрим для сахарных черепов (04.11.2020)"  # Убедитесь, что заголовок не пустой
description = "Just Chatting, Keep Talking and Nobody Explodes, We Were Here Together"
tags = "unuasha, юняша, twitch, стрим, Just Chatting, Keep Talking and Nobody Explodes, We Were Here Together"  # Теги как строка
